...
describe("Telegram personal Shared repeat delivery", () => {
  ...
  test("concurrent first contacts converge on one signup-funded account", async () => {
...
describe("Discord personal Shared repeat delivery", () => {
  ...
  test("concurrent first contacts converge without provisioning an API key or sandbox", async () => {
