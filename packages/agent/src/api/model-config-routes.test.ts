...
describe("POST /api/models/config coding writes", () => {
  ...
  it("rejects the removed opencode backend without writing", async () => {
...
describe("GET /api/models/config activeChat", () => {
  ...
  it("names the cloud brain + its endpoint under cloud-proxy routing", async () => {
    ...
    // sees what actually serves. Managed Cloud deliberately pins both text
    // tiers to the same provider-native model.
